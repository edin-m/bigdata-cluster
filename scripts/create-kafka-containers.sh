...
docker cp cluster/kafka/config/server-1.properties kafka1:/home/hadoop/kafka/config/server.properties
docker cp cluster/kafka/config/server-2.properties kafka2:/home/hadoop/kafka/config/server.properties
